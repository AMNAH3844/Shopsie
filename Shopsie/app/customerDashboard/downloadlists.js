...
export default function DownloadLists() {
  ...
  const isRequestRiderFlow =
    flow === "request_rider" || source === "riderDirect";
  ...
  const getLocation = (list, type) => {
    const latKey =
      type === "delivery" ? "deliveryLocationLat" : "buyingLocationLat";
    const lngKey =
      type === "delivery" ? "deliveryLocationLng" : "buyingLocationLng";
    const labelKey =
      type === "delivery" ? "deliveryLocationLabel" : "buyingLocationLabel";
        ...
        {fetchError && (
          <View style={styles.orangeWarningBanner}>
            ...
            <Text style={styles.warningText}>
              Could not fetch downloaded profiles. Displaying local data if
              available.
            </Text>
          </View>
        )}
          ...
          renderItem={({ item }) => (
            <View style={styles.listCard}>
              ...
              <View style={styles.actionsContainer}>
                ...
                >
                  <Ionicons name="create-outline" size={24} color="#7a8ba8" />
                </TouchableOpacity>
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalBoxLarge}>
              ...
              <View style={styles.locationSummary}>
                <Text style={styles.locationTitle}>Buying Location</Text>

                <Text style={styles.locationText}>
                  {selectedList?.items?.[0]?.buyingLocationLabel ||
                    "Not Available"}
                </Text>
                ...
                <Text style={styles.locationText}>
                  {selectedList?.items?.[0]?.deliveryLocationLabel ||
                    "Not Available"}
                </Text>
              </View>
              ...
              >
                {(selectedList?.items || []).map((i, idx) => (
                  <View key={idx} style={styles.modalItemBlock}>
                    ...
                    <Text style={styles.modalMeta}>Qty: {i.quantity}</Text>
          ...
          <View style={styles.overlay}>
            <View style={styles.popup}>
              ...
              <Text style={styles.modalSubtitle}>
                Do you want to share the list "{selectedList?.name}" via friend
                or rider?
              </Text>
        ...
        <Modal visible={optimizeModal} transparent animationType="fade">
          <View style={styles.overlay}>
            <View style={styles.popup}>
              ...
              <Text style={styles.modalSubtitle}>
                Do you want to optimize the shopping route for the list "
                {selectedList?.name}"?
              </Text>
