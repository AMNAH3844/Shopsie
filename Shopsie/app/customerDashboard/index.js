...
>
    <View style={styles.container}>
      ...
      <View style={styles.grid}>
        <TouchableOpacity style={styles.card} onPress={() => router.push("/customerDashboard/createlist")}>
          <MaterialCommunityIcons name="playlist-edit" size={35} color="white" />
          <Text style={styles.cardText}>Create List</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.card} onPress={() => router.push("/customerDashboard/friends")}>
        ...
        <TouchableOpacity style={styles.card} onPress={() => setShowOptimizePopup(true)}>
      ...
      <Modal visible={showPopup} transparent animationType="fade">
        <View style={localStyles.modalOverlay}>
          <View style={localStyles.modalBox}>
            <TouchableOpacity onPress={() => setShowPopup(false)} style={localStyles.closeCornerBtn}>
              <Text style={localStyles.closeX}>✕</Text>
            </TouchableOpacity>

            <Text style={localStyles.modalTitle}>Share List</Text>
            <Text style={localStyles.modalSubtitle}>From where you want to share?</Text>

            <View style={localStyles.shareButtonsRow}>
              <TouchableOpacity
                onPress={() => {
                  setShowPopup(false);
                  router.push({ pathname: "/customerDashboard/savedlist", params: { flow: "request_rider" } });
                }}
              ...
              <TouchableOpacity
                onPress={() => {
                  setShowPopup(false);
                  router.push({ pathname: "/customerDashboard/downloadlists", params: { flow: "request_rider" } });
                }}
      ...
      <Modal visible={showOptimizePopup} transparent animationType="fade">
        <View style={localStyles.modalOverlay}>
          <View style={localStyles.modalBox}>
            <TouchableOpacity onPress={() => setShowOptimizePopup(false)} style={localStyles.closeCornerBtn}>
              <Text style={localStyles.closeX}>✕</Text>
            </TouchableOpacity>

            <Text style={localStyles.modalTitle}>Optimize Route</Text>
            <Text style={localStyles.modalSubtitle}>From where you want to optimize?</Text>

            <View style={localStyles.shareButtonsRow}>
              <TouchableOpacity
                onPress={() => {
                  setShowOptimizePopup(false);
                  router.push({ pathname: "/customerDashboard/savedlist", params: { source: "optimize" } });
                }}
                style={[localStyles.modalBtn, { backgroundColor: "#f06543", marginRight: 10 }]}
              >
                <Text style={localStyles.modalBtnText}>Saved List</Text>
              ...
              <TouchableOpacity
                onPress={() => {
                  setShowOptimizePopup(false);
                  router.push({ pathname: "/customerDashboard/downloadlists", params: { source: "optimize" } });
                }}
                style={[localStyles.modalBtn, { backgroundColor: "#2e4466" }]}
              >
                <Text style={localStyles.modalBtnText}>Downloaded</Text>
