  ...
  return (
    <View style={localStyles.mainContainer}>
      ...
      <FlatList
        ...
        ListHeaderComponent={<Text style={localStyles.sectionHeading}>Current Inventory Status</Text>}
        renderItem={({ item }) => {
            ...
            <View style={localStyles.card}>
              <View style={localStyles.cardHeaderRow}>
                ...
                <View style={[
                  ...
                  isLowStock ? localStyles.lowStockBadge : localStyles.normalStockBadge
                ]}>
                  <Text style={[
                    localStyles.stockBadgeText, 
                    isLowStock ? localStyles.lowStockText : localStyles.normalStockText
                  ]}>
                    {isLowStock ? `⚠️ Low Stock: ${item.quantity}` : `${item.quantity} Available`}
                  </Text>
                </View>
              </View>
              ...
              <View style={localStyles.infoGrid}>
                ...
                <View style={localStyles.infoColumn}>
                  ...
                  <Text style={[localStyles.infoValue, isLowStock && { color: '#EF4444' }]}>
              ...
              <View style={localStyles.specContainer}>
                ...
                <Text style={localStyles.specValueText} numberOfLines={2}>
                  {item.specification || "No supplemental details provided for this inventory stock profile."}
                </Text>
              </View>
            </View>
          );
...
const localStyles = StyleSheet.create({
  ...
  cardHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12, width: '100%' },
  productTitle: { fontSize: 17, fontWeight: '700', color: '#0F172A', flex: 1, marginRight: 8 },
  ...
  specValueText: { fontSize: 13, color: '#475569', lineHeight: 18, marginTop: 2 }
});